...
export default {
  ...
  mounted () {
    ...
    //         { key: 'start_ts', type: '开始时间', description: 'timestamp' },
    //         { key: 'end_ts', type: '结束时间', description: 'timestamp' },
    //         { key: 'state', type: '进驻状态', description: 'int' }
    //       ],
    //       return: [],
    //       explain: []
    //     },
      ...
      content: [
        ...
        },
        {
          ...
          explain: [
            ...
            { key: 'company_id', type: 'int', description: '企业的id,用于获取企业详情的时候使用' },
